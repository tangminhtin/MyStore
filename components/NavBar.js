        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link href="/">
                <a className={"nav-link " + classes.navLink + isActive("/")} aria-current="page">
            ...
            <li className="nav-item">
              <Link href="/cart">
                <a className={"nav-link " + classes.navLink + isActive("/cart")}>
            ...
            <li className="nav-item dropdown">
              <a
                ...
                aria-expanded="false"
              >
                <i className="fas fa-user-circle" aria-hidden></i> Tài khoản
              </a>
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li>
                  <a className="dropdown-item" href="#">
                    <i className="fas fa-sign-out-alt" aria-hidden></i> Đăng
                    xuất
                  </a>
                </li>
              </ul>
